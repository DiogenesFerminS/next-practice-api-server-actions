...
import { addProductToCart, deleteProduct } from "@/shopping-cart/actions/actions";
    ...
    <div className="bg-white shadow rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-100">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm font-bold text-gray-900 dark:text-white">${price.toFixed(2)}</span>
